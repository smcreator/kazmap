...
namespace KazMap.Routing
{
    ...
    public class DeikstraModel
    {
        ...
        private List<Intersections> _intersections;
        ...
        public DeikstraModel(List<Path> matrix, List<Intersections> intersections)
        {
            _matrix = matrix;
        ...
        {
            return _matrix.Where(m => m.LeftIntersectionId == id).Select(m => 
        ...
        {
            // TODO: это можно вычиcлить заранее в Intersection!
            ...
            var averageSpeed = _intersections.Where(i => i.Id == intersection.Id).
                Select(i => i.AverageSpeed.Value).First();
            ...
            return (int)Math.Ceiling(Math.Abs(
                ...
                endPoint.Latitude) * 3600) / averageSpeed);
        }
    }
}
